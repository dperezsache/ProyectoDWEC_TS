...
export class VistaModificar extends Vista {
    ...
    aceptar() {
        ...
        if (cont == 7) {
            ...
            this.controlador.actualizarCRUD(parseInt(this.listado.value), this.campoNombre.value, this.campoFecha.value, this.campoPrecio.value, this.campoDescripcion.value, this.campoTipo.value, this.campoImagen.files[0], this.seguro1.checked, this.seguro2.checked, this.seguro3.checked);
            this.cancelar();
        }
        else {
